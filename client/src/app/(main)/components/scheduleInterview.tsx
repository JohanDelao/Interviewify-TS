    ...
    return (
        <div className="w-full h-fit rounded-xl bg-white border-2 border-accent/10 p-4 flex flex-col gap-3 items-center">
            ...
            <div className="w-full flex justify-between items-center">
                ...
                <button className="w-40 rounded bg-secondary/80 h-10 flex items-center justify-center transition-colors hover:bg-secondary">
                    <p className="text-white font-redHatText font-semibold text-base">Start Interview</p>
                </button>
            </div>
        </div>
    )
